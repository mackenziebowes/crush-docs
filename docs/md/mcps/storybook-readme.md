# [Storybook MCP](https://github.com/storybookjs/mcp) - Contributor Guide

Welcome to the [Storybook](https://github.com/storybookjs) MCP Addon monorepo! This project enables AI agents to work more efficiently with Storybook by providing an MCP (Model Context Protocol) server that exposes UI component information and development workflows.
